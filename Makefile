...
AWS_ACCOUNT_ID := 183295420890
AWS_REGION := us-east-1

# Docker repository names (customizable)
CODE_LOCATION_REPO_NAME := coing-analytics-dagster-code-locationtf01
WEBSERVER_REPO_NAME := coing-analytics-dagster-web-servertf01
DAEMON_REPO_NAME := coing-analytics-dagster-daemontf01

# Terraform variables
TERRAFORM_DIR := terraform
MODULES := IAM networking ecr rds s3 efs datasync
